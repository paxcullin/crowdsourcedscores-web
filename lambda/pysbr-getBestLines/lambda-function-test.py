...
endDate = datetime.strptime('2025-09-23', '%Y-%m-%d')
...
print('nfl: ', nfl.sport_id, nfl.league_id)
markets = MarketsByMarketIds(nfl.market_ids('pointspread'), nfl.sport_id)
# print('games: ',e.list())
print('markets: ', markets.list())
