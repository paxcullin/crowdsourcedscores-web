...
const uri = `mongodb+srv://pcsm-user:${password}@pcsm.lwx4u.mongodb.net/pcsm?retryWrites=true&w=majority`;
console.log('uri:', uri);
...
exports.handler = (event, context) => {
    ...
    const { userId, preferred_username, sport, gameWeek, season, year, compareUsername } = event; 
    client.connect((db) => {
        ...
        collection.find(gamesQuery, gamesProjection, {sort: {"startDateTime": 1 }}).toArray(function (err, gamesArray) {
            ...
            db.collection(predictionsCollectionName).find(predictionsQuery, {_id: false}).toArray(function (err, predictions) {
